...
const experiences = [
  {
    role: 'UI/UX Designer',
    company: 'Self-Internship / Freelance',
    period: '1 Year 6 Months',
    type: 'Freelance',
    description: 'Worked as a self-driven freelance UI/UX designer for 1 year 6 months, creating user-focused designs and interactive prototypes using Figma. Designed mobile and web interfaces, developed wireframes, user flows, and high-fidelity prototypes while focusing on usability, visual consistency, and improving overall user experience.',
    highlights: [
      'Created user-focused designs and interactive prototypes using Figma',
      'Developed wireframes, user flows, and high-fidelity interfaces',
      'Practiced design thinking and delivered solutions based on project requirements'
    ],
  },
];
      ...
      <div className="relative w-full max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="exp-title mb-16 md:mb-24 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <p className="text-[#1a1a1a]/60 text-sm md:text-base max-w-xs font-medium leading-relaxed">
            1.5 years of crafting user-focused digital experiences and interactive prototypes.
          </p>
        </div>
